...
public class CleveLandZ implements Tetromino {
    ...
    public void turn(BoardStatus[][] gameboard) {
        switch (turn_counter % 4) {
            case 0:
                if (    CheckOutOfBounds(coords[0].getX(), coords[0].getY() + 2, gameboard) &&
                        CheckOutOfBounds(coords[1].getX() + 1,coords[1].getY() + 1,gameboard) &&
                        CheckOutOfBounds(coords[3].getX() + 1, coords[3].getY() - 1, gameboard) &&
                        CheckForCollision(coords[0].getX(), coords[0].getY() + 2, gameboard) &&
                ...
                break;
            case 1:
                if(     CheckForCollision(coords[0].getX() + 2, coords[0].getY(), gameboard) &&
                        CheckForCollision(coords[1].getX() + 1 ,coords[1].getY() - 1,gameboard) &&
                        CheckForCollision(coords[3].getX() - 1, coords[3].getY() - 1, gameboard)){

                    if (    CheckOutOfBounds(coords[0].getX() + 2, coords[0].getY(), gameboard) &&
                            CheckOutOfBounds(coords[1].getX() + 1 ,coords[1].getY() - 1, gameboard) &&
                            CheckOutOfBounds(coords[3].getX() - 1, coords[3].getY() - 1, gameboard)) {
